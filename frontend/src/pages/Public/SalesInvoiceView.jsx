...
import { buildSalesInvoiceHTML } from '../../utils/salesInvoice';
import { getPublicSalesOrder } from '../../api/jobcards';

export default function PublicSalesInvoiceView() {
  ...
  useEffect(() => {
    getPublicSalesOrder(token)
      .then(({ order, business }) => setHtml(buildSalesInvoiceHTML(order, business)))
