...
const NOTIFY_TOGGLES = [
  ...
  { key: 'NOTIFY_SERVICE_REMINDER',      label: 'Service Due (2 days before)', desc: 'Sent 2 days before a vehicle service is due' },
  { key: 'NOTIFY_SERVICE_TODAY',         label: 'Service Due Today',           desc: 'Sent on the day the vehicle service is due' },
